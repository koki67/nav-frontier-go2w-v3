...
See `docs/architecture.md` for the dataflow, `docs/topics.md` for the full topic catalog, `docs/result-recording.md` for rosbag output/replay, `docs/velocity-bridge.md` for the bridge contract, and `docs/troubleshooting.md` for common issues.
